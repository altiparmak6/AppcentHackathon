...
class ChallengesTableViewCell: UITableViewCell {
    ...
    private let challengeImageView: UIImageView = {
        ...
        challengeImageView.layer.cornerRadius = 40
    ...
    override func layoutSubviews() {
        ...
        NSLayoutConstraint.activate([
            ...
            challengeImageView.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 10),
            ...
            titleLabel.topAnchor.constraint(equalTo: challengeImageView.topAnchor),
    ...
    func configure(with model: ChallengesModel) {
        challengeImageView.image = model.image
        titleLabel.text = model.title
        detailLabel.text = model.detail
        scoreLabel.text = "+\(model.totalScore)"
    }
}
